...
Run-list queries select summary columns only. Full measurements are loaded only
after a plate is selected, streamed in bounded chunks by repository adapters, and
cached by immutable plate/revision identity.
